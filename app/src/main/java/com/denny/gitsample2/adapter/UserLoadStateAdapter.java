...
public class UserLoadStateAdapter extends LoadStateAdapter<UserLoadStateAdapter.LoadStateViewHolder> {
    // Define Retry Callback
    private View.OnClickListener mRetryCallback;

    public UserLoadStateAdapter(View.OnClickListener retryCallback) {
        // Init Retry Callback
